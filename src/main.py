...
# 🔥 중요: 사이드바에서 테마를 정한 직후에 스타일을 적용해야 실시간으로 바뀜
    ...
    with st.chat_message("assistant"):
        if vector_db and llm:
            ...
            with st.spinner("AI 전문가가 데이터를 분석 중입니다..."):
                ...
                weather_context = f"[현재 정보] 위치:{selected_location}, 날씨:{weather.get('temp')}도, 병해충:{pest_summary}"
